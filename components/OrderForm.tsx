...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const googleSheetUrl = 'https://script.google.com/macros/s/AKfycbyF8eZi70yKf9t8jz7ZIhY-hy22Q7ViRyQYROWUDp71JPXSRO4C-4bhVoFGv2LLNa98/exec';

    try {
      // 1. محاولة إرسال البيانات إلى Google Sheet
      try {
      ...
      // 2. فتح WhatsApp (الرقم: 0772136223)
      ...
      <section id="order" className="py-20 bg-white">
        <div className="max-w-xl mx-auto px-4 text-right">
          <div className="bg-emerald-50 border-2 border-emerald-100 rounded-3xl p-12 text-center shadow-xl">
            ...
            <button onClick={resetForm} className="mt-8 text-emerald-600 font-bold hover:underline">
              تقديم طلب آخر
            </button>
          </div>
        </div>
