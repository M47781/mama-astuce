...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // رابط SheetBest الخاص بك
    const sheetBestUrl = 'https://api.sheetbest.com/sheets/c8564913-f657-408f-9f0b-72f86891aec2';

    try {
      // 1. إرسال البيانات إلى Google Sheet عبر SheetBest
      // ملاحظة: SheetBest يتطلب إرسال البيانات داخل مصفوفة [ ]
      ...
      // 2. إعداد رسالة WhatsApp (الرقم: 0772136223)
      ...
      <section id="order" className="py-20 bg-white" dir="rtl">
        <div className="max-w-xl mx-auto px-4 text-center">
          <div className="bg-emerald-50 border-2 border-emerald-100 rounded-3xl p-12 shadow-xl">
            ...
            <p className="text-lg text-gray-600">شكراً لك، ستجد بياناتك في الجدول وسيتم التواصل معك هاتفياً.</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="space-y-8 order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-600">املأ الاستمارة لتسجيل طلبك في نظامنا وتأكيده عبر واتساب.</p>
